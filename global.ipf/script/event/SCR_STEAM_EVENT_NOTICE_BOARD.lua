function SCR_STEAM_TREASURE_EVENT_DIALOG(self,pc)
    ...
    local select = ShowSelDlg(pc, 0, 'EV_DAILYBOX_SEL', ScpArgMsg("EVENT_STEAM_2018REWARD_DLG1"), ScpArgMsg("EVENT_STEAM_2018REWARD_DLG2"), ScpArgMsg("EVENT_1909_ANCIENT_DLG1"), ScpArgMsg("Cancel"))
    ...
    elseif select == 3 then
        SCR_EVENT_1909_ANCIENT_DIALOG(self, pc)
    end
end
