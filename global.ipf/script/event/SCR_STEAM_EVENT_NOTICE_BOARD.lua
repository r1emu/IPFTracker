function SCR_STEAM_TREASURE_EVENT_DIALOG(self,pc)
    ...
    local select = ShowSelDlg(pc, 0, 'EV_DAILYBOX_SEL', ScpArgMsg("EVENT_STEAM_TULIP_FESTIVAL_LIST_2"), ScpArgMsg("EVENT_STEAM_2018REWARD_DLG1"), ScpArgMsg("EVENT_STEAM_2018REWARD_DLG2"), ScpArgMsg("Cancel"))
  
    if select == 1 then
        SCR_EVENT_STEAM_TULIP_LIST_DIALOG(self, pc)
